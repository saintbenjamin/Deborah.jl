# ============================================================================
# src/DeborahCore/MLSequenceRidge.jl
#
...
Train and evaluate a [Ridge regression model](https://juliaai.github.io/MLJ.jl/stable/models/RidgeRegressor_MLJLinearModels/#RidgeRegressor_MLJLinearModels) using the [`JuliaAI/MLJ.jl`](https://juliaai.github.io/MLJ.jl/stable/) framework.
...
function ml_sequence_Ridge(; 
    ...
    model = RidgeRegressor(; model_kwargs...)
