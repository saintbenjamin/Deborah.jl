# ============================================================================
# src/Sarah/AvgErrFormatter.jl
#
# Shared module mirrored between Deborah.jl and Maranatha.jl.
# This file is the historical origin of the shared implementation.
#
# The Deborah.jl and Maranatha.jl copies may evolve independently for some time;
# neither copy should be assumed to be permanently authoritative. Changes made
# here should be reviewed against the corresponding Maranatha.jl file and
